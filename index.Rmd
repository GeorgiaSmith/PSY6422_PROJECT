---
title: "Proportionality and Divergance of Autism Spectrum Disorder Prevalence between Male and Female Children"
author: "Georigia Smith"
output:
...
If the trends are proportional, it suggests that the prevalence rates increase at a similar rate or follow a similar pattern in both biological sexes. Conversely, if the trends are not proportional, it implies that there are differences in the changes in prevalence rates between males and females.
There may be underlying factors that are causing the prevalence rates in males and females to diverge over time.
```{r}
...
This is included in the subtitle of the visualizsation to provide conceptual information and aid in understanding the plot.This provides some top-down analysis when interpreting the graph, which has been shown to improve graphicacy (Shah & Freedman, 2011). 
